...
namespace Spark2Scale_.Server.Models
{
    ...
    ///   json_response, logo_path, cheat_sheet
    /// </summary>
    [Table("startups")]
    public class Startup : BaseModel
    {
        ...
        /// <summary>
        /// Internal AI cache: compressed VCCheatSheet generated by the Python pitch analyzer.
        /// Written by the Python /extract pipeline; read on subsequent pitch sessions to skip
        /// the 30-60s LLM re-extraction step.
        /// NOT exposed in any DTO — never sent to the frontend.
        /// </summary>
        [Column("cheat_sheet")]
        public object? CheatSheet { get; set; }
    }
